...
Ни в одном андроид-смартфоне из тех, что я держал в руках, не было возможности указать адреса DNS-серверов нижеописанным образом. В том числе и в телефоне Honor 9 с ОС Android 8.0.0. Сформулируйте этот раздел соответствующим образом - что, мол, в некоторых телефонах, возможно, если повезёт, вы сможете изменять настройки DNS.
...
В старых роутерах Zyxel Keenetic возможность задать адреса DNS-серверов в свойствах интернет-подключения есть, но эти, указанные вручную, адреса операционная система роутеров ставит в конец списка. В начале списка идут адреса Яндекс DNS (если опция включена), затем адреса DNS-серверов, автоматически получаемые от интернет-провайдера и только потом адреса, указанные вручную. Таким образом, до последнийх очередь не доходит никогда. В новых роутерах семейства Keenetic (без Zyxel) появилась специальная настройка для Adguard DNS.
<a id="ubuntu"></a>
